        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="${properties.kcInputWrapperClass!} input-group date-time-picker-pf" id="birth-date-picker">
                    <input type="text" class="${properties.kcInputClass!}" id="user.attributes.birthdate" name="user.attributes.birthdate" value="${(register.formData['user.attributes.birthdate']!'')}"/>
                </div>
            </div>
          ...
          <#if !realm.registrationEmailAsUsername>
            ...
            <script>
                ...
                var $visaSelect = $('#user-attributes-visaType').selectize();
